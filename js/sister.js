...
//     WP_Statistics_http.open(
//       'GET',
//       wps_statistics_object.rest_url +
//         'wpstatistics/v1/hit' +
//         (wps_statistics_object.rest_url.includes('?') ? '&' : '?') +
//         '_=' +
//         Math.floor(Date.now() / 1e3) +
//         '&_wpnonce=' +
//         wps_statistics_object.wpnonce +
//         '&wp_statistics_hit_rest=yes&ua=' +
//         navigator.userAgent +
//         '&url=' +
...
//     if (bgurl != '') {
//       if (
//         bgurl == 'https://view.moezx.cc/images/2018/01/03/sakura.png' ||
//         bgurl == 'https://view.moezx.cc/images/2018/01/03/plaid2dbf8.jpg' ||
//         bgurl == 'https://view.moezx.cc/images/2018/01/10/star02.png' ||
//         bgurl == 'https://view.moezx.cc/images/2018/01/24/kyotoanimation.png' ||
//         bgurl == 'https://view.moezx.cc/images/2018/09/17/little-monster.png'
//       ) {
...
//             }
//             !comm
//               ? ((temp = t.I('wp-temp-form-div')), (t.I('comment_parent').value = '0'), temp.parentNode.insertBefore(respond, temp), temp.parentNode.removeChild(temp))
...
//     if (Poi.pjax) {
//       $(document)
//         .pjax('a[target!=_top]', '#page', { fragment: '#page', timeout: 8000 })
//         .on('pjax:beforeSend', () => {
